...
class KittiDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None,val=None):
        ...
        print('length of dataset',len(self.sample_id_list))
        self.kitti_infos = []
    ...
    def include_kitti_data(self, mode):
        ...
        for info_path in self.dataset_cfg.INFO_PATH[mode]:
            ...
            with open(info_path, "rb") as f:
                infos = pickle.load(f)
                kitti_infos.extend(infos[:len(self.sample_id_list)])
...
if __name__ == "__main__":
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == "create_kitti_infos":
        ...
        create_kitti_infos(
            ...
            data_path=Path("/home/data/kitti"),
            save_path=Path("/home/data/kitti"),
        )
